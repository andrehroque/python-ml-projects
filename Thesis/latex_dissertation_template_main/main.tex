...
\newcommand{\thesistitle}{Experimental Measurement of Bargmann Invariants using a Nuclear Magnetic Resonance Quantum Computer}			% Your work's title
\newcommand{\myname}{André Roque}				% Your name
\newcommand{\statedate}{Coimbra, \MONTH\ \YEAR}					% The date, usually "Place, Month Year"
\newcommand{\supervisorname}{Rui Vilão}		% Your supervisor's name
\newcommand{\cosupervisorname}{Sagar Pratapsi \linebreak co-supervisor 2}	% Your co-supervisor's name, if any.
...
\chapter{Liquid State NMR}
~\label{chap:liquidstateNMR}
\input{chapters/liquidstateNMR}

%-----CHAPTER2-QUANTUM-COMPUTING-WITH-NMR-----
\chapter{Quantum Computing with NMR}
~\label{chap:quantum_nmr}
\input{chapters/quantum_nmr}

%-----CHAPTER3-DESIGN-OF-RADIO-FREQUENCY-CONTROL-PULSES-----
\chapter{Radio Frequency Pulse Design}
~\label{chap:pulse_design}
\input{chapters/pulse_design}

%-----CHAPTER4-IMPLEMENTATION-OF-THE-SWAP-TEST-----
\chapter{Implementation of the SWAP test}
~\label{chap:swaptest}
\input{chapters/swaptest}
